...
* [ibm-semeru-11](https://github.com/carlossg/docker-maven/blob/master/ibm-semeru-11/Dockerfile)
* [ibm-semeru-17](https://github.com/carlossg/docker-maven/blob/master/ibm-semeru-17/Dockerfile)
...
This is a base image that you can extend, so it has the bare minimum packages needed. If you add custom package(s) to the `Dockerfile`, then you can build your local Docker image like this:
    ...
    docker build --tag my_local_maven:3.8.4-jdk-8 .
