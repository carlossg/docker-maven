...
* [microsoft-openjdk-17-ubuntu-maven-4](https://github.com/carlossg/docker-maven/blob/main/microsoft-openjdk-17-ubuntu-maven-4/Dockerfile)
* [microsoft-openjdk-21-ubuntu](https://github.com/carlossg/docker-maven/blob/main/microsoft-openjdk-21-ubuntu/Dockerfile)
* [microsoft-openjdk-21-ubuntu-maven-4](https://github.com/carlossg/docker-maven/blob/main/microsoft-openjdk-21-ubuntu-maven-4/Dockerfile)
* [microsoft-openjdk-25-ubuntu](https://github.com/carlossg/docker-maven/blob/main/microsoft-openjdk-25-ubuntu/Dockerfile)
* [microsoft-openjdk-25-ubuntu-maven-4](https://github.com/carlossg/docker-maven/blob/main/microsoft-openjdk-25-ubuntu-maven-4/Dockerfile)
...
This is a base image that you can extend, so it has the bare minimum packages needed. If you add custom package(s) to the `Dockerfile`, then you can build your local Docker image like this:
    ...
    docker build --tag my_local_maven:3.9.11-jdk-8 .
